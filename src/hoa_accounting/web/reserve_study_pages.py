...
class ReserveStudyPages:
    ...
    def _base_ctx(
        self, org: dict[str, Any], theme: str, page_key: str = "reserve-study"
    ) -> dict[str, Any]:
        return {
    ...
    def render_summary(
        ...
        if assumptions is None:
            ...
            return PageResponse(
                HTTPStatus.OK, render_template("reserve_study_summary.html", ctx)
            )
        ...
        per_lot_liability = (
            _q2(total_current_cost / num_lots) if num_lots > 0 else Decimal("0")
        )
        ...
        funding_status = (
            ...
            else ("LOW" if percent_funded < 70 else "ADEQUATE")
        )
        ...
        *,
        ...
        if assumptions and not form_data:
            fd = {
                ...
                "reserve_balance_override": str(
                    assumptions["reserve_balance_override"] or ""
                ),
                "annual_contribution": str(assumptions["annual_contribution"]),
                "contribution_growth_rate": str(
                    float(assumptions["contribution_growth_rate"]) * 100
                ),
                "investment_return_rate": str(
                    float(assumptions["investment_return_rate"]) * 100
                ),
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_assumptions.html", ctx)
        )
    ...
    def handle_save_assumptions(
        ...
        assumptions = self._repo.get_active_assumptions()
        if assumptions is None:
            return None, self.render_assumptions_form(
                org=org,
                theme=theme,
    ...
    def render_assets(
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_assets.html", ctx)
        )
    ...
    def render_asset_form(
        ...
        *,
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_asset_form.html", ctx)
        )
    ...
    def handle_save_asset(
        ...
        *,
        ...
        if not asset_group or not component:
            return None, self.render_asset_form(
                asset_id,
                org=org,
                theme=theme,
    ...
    def render_funding_plan(self, *, org: dict[str, Any], theme: str) -> PageResponse:
        ...
        if assumptions is None:
            ...
            return PageResponse(
                HTTPStatus.OK, render_template("reserve_study_funding_plan.html", ctx)
            )
        ...
        opening_balance = (
            _q2(override)
            if override is not None
            else self._repo.get_reserve_fund_balance()
        )
    ...
    def render_scenarios(
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_scenarios.html", ctx)
        )
    ...
    def render_scenario_form(
        ...
        *,
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_scenario_form.html", ctx)
        )
    ...
    def handle_save_scenario(
        ...
        *,
        ...
        if not scenario_name:
            return None, self.render_scenario_form(
                scenario_id,
                org=org,
                theme=theme,
    ...
    def render_report_preview(self, *, org: dict[str, Any], theme: str) -> PageResponse:
        ...
        if assumptions is None:
            ...
            ctx = {
                **self._base_ctx(org, theme, "reserve-study"),
                ...
                "message": (
                    "No active reserve study assumptions found. "
        ...
        assumption_rows = [
            ...
            (
                ...
                f"{float(assumptions['contribution_growth_rate'])*100:.1f}%",
            ),
            (
                "Investment Return Rate",
                f"{float(assumptions['investment_return_rate'])*100:.1f}%",
            ),
        ...
        condition_key = [
            (
                "Excellent",
                "pill--excellent",
                "New or recently replaced; no concerns for many years",
            ),
            ("Good", "pill--ok", "Functioning well; no immediate concerns"),
            (
                "Moderate",
                "pill--warn",
                "Showing wear; plan for replacement within useful life",
            ),
            ("Poor", "pill--danger", "Needs replacement soon; risk of failure"),
            (
                "Critical",
                "pill--critical",
                "Past useful life or at high risk of failure — immediate action needed",
            ),
        ]
        ...
        return PageResponse(
            HTTPStatus.OK, render_template("reserve_study_report.html", ctx)
        )
