...
def build_accounts_list_context(
    *,
    ...
    return ListPageContext(
        ...
        description=(
            "All accounts used by the system — bank, receivable, equity, and "
            "fund balance. Expense accounts show their HOA spending group; "
            "income and balance-sheet accounts leave the Group column blank."
        ),
        columns=cols,
        rows=vm_rows,
